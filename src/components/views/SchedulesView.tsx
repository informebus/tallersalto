  ...
  return (
    <div className="space-y-6 pb-12">
                ...
                <div>
                  ...
                  <div className="p-3.5 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <button
                      ...
                      title="Eliminar horario (Requiere PIN 0987)"
                    >
                  ...
                  {/* Thumbnail Image */}
                  <div className="relative group p-3 bg-slate-50">
                    <img
                      src={h.foto}
                      alt={h.titulo}
                      className="w-full h-36 object-contain bg-white rounded-lg border border-slate-200"
                    />
                    <button
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wider">
                Tabla Oficial de Códigos de Destinos
              </h3>
              <p className="text-xs text-slate-500">
                Códigos numéricos para configuración de banderas y letreros
              </p>
            </div>
          </div>
        ...
        {codigos?.foto ? (
          <div className="relative group rounded-xl overflow-hidden border border-slate-200 bg-slate-50 max-h-72">
            <img
              src={codigos.foto}
              alt="Códigos de Destino"
